...
const AWARD_CARDS = [
  {
    ...
    descriptionNL: "Custom hout en acryl award met geïntegreerde LED-verlichting en spiegels. Gemaakt voor de organisatoren van het Nederlands kampioenschap human beatbox.",
    descriptionEN: "Custom wood and acryl award with integraded LED lights and mirrors. Made for the organizers of the Dutch human beatbox championship.",
    images: [
      "/img/award01.jpeg",
    ],
  },
